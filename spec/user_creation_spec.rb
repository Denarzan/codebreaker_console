...
RSpec.describe UserCreation::UserCreation do
  subject(:view) { View }
  let(:user1) do
  ...
  describe '#create_user' do
    context '#name_init' do
      before do
        allow(view).to receive(:get_input).and_return('Nazar', 'exit')
    ...
    context '#name_init' do
      before do
        allow(view).to receive(:get_input).and_return('N')
    ...
    context '#name_init' do
      before do
        allow(view).to receive(:get_input).and_return('Nazar', 'monkey', 'monkey2')
        allow(game_double).to receive(:take_name).and_return('Nazar')
    ...
    context '#difficulty_init' do
      before do
        allow(view).to receive(:get_input).and_return('Nazar', 'easy')
        allow(game_double).to receive(:take_name).and_return('Nazar')
    ...
    context '#difficulty_init' do
      before do
        allow(view).to receive(:get_input).and_return('Nazar', 'medium')
        allow(game_double).to receive(:take_name).and_return('Nazar')
    ...
    context '#difficulty_init' do
      before do
        allow(view).to receive(:get_input).and_return('Nazar', 'hell')
        allow(game_double).to receive(:take_name).and_return('Nazar')
